...
>
  <div class="w-full">
    <div class="mx-auto max-w-xl px-6">
      ...
      <p class="mb-6 text-base text-white/40">
      ...
      <!-- location glitch -->
      <p class="mb-10 font-mono text-sm text-white/35">{locationDisplay}</p>

      <!-- links row -->
      <div class="flex flex-wrap items-center gap-x-0 gap-y-3 text-[13px] text-white/40">
        <a
