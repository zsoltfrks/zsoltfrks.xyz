        ...
        <ul class="grid grid-cols-1 gap-2 font-mono sm:grid-cols-2 sm:gap-3">
          {#each links as link}
            <li class="flex">
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" class="shrink-0 text-white/35 transition-colors group-hover:text-white/55" aria-hidden="true">
                  {@html link.icon}
                </svg>
                <span class="text-xs">
                  <span class="text-white/50">{link.label}</span>
                  <span class="text-white/25" aria-hidden="true"> · </span>
                  <span class="text-white/75 transition-colors group-hover:text-white/90">{link.display}</span>
                </span>
              </a>
            </li>
          {/each}
