...
export const experience = [
  {
    ...
    about: 'Part of KESZ Group, one of the largest construction and engineering companies in Hungary. The internship focused on developing internal automation tools to optimize operational workflows during my BSc studies.',
    type: 'full-time',
    bullets: [
  ...
  },
  {
    ...
    tech: ['Lua', 'HLSL', 'Chromium Embedded Framework', 'Docker', 'AWS', 'Jira'],
    skills: ['Algorithmic Thinking', 'Product Development', 'Project Management'],
  },
]
